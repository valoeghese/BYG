...
public class SmallYellowTaigaTree extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public SmallYellowTaigaTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn) {
        super(configIn, doBlockNotifyIn);
        setSapling((net.minecraftforge.common.IPlantable) BlockCatalogs.YELLOW_SPRUCE_SAPLING);
    }
