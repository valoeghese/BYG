...
public class DeciduousBirch extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public DeciduousBirch(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn) {
        super(configIn, doBlockNotifyIn);
        //setSapling((net.minecraftforge.common.IPlantable) Blocks.DARK_OAK_SAPLING);
    }

    public DeciduousBirch() {
        super(null, true);
    } //
