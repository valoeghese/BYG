...
public class SDeciduousShrub extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public SDeciduousShrub(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn) {
        super(configIn, doBlockNotifyIn);
        //setSapling((net.minecraftforge.common.IPlantable) Blocks.DARK_OAK_SAPLING);
    }

    public SDeciduousShrub() {
        super(null, true);
    } //
                    ...
                    if (leaveColor == 1) {
                        ...
                        for (int posXLeafWidth = -leavessquarespos; posXLeafWidth <= leavessquarespos; ++posXLeafWidth) {//has to do with leaves
                            for (int posZLeafWidthL0 = -leavessquarespos; posZLeafWidthL0 <= leavessquarespos; ++posZLeafWidthL0) {
                                ...
                                int leafPreset = rand.nextInt(2) + 1;
                                if (leafPreset == 1) {
