...
public class YellowBirch extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public YellowBirch(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn) {
