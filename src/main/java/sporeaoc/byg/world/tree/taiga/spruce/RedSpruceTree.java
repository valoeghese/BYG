...
public class RedSpruceTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public RedSpruceTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn) {
