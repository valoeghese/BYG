package sporeaoc.byg.world.tree.taiga.giantspruce;
...
public class GiantOrangeSpruceTree extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    private static final BlockState LEAVES2 = BlockCatalogs.ORANGE_SPRUCE_LEAVES.getDefaultState();

    public GiantOrangeSpruceTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn) {
        super(configIn, doBlockNotifyIn);
        setSapling((net.minecraftforge.common.IPlantable) BlockCatalogs.ORANGE_SPRUCE_SAPLING);
    }
