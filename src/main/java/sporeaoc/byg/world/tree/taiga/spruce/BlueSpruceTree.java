...
public class BlueSpruceTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public BlueSpruceTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
