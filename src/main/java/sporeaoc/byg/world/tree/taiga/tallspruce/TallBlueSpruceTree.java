...
public class TallBlueSpruceTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public TallBlueSpruceTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
