...
public class OrangeSpruceTree extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    private static final BlockState LEAVES3 = BlockCatalogs.ORANGE_SPRUCE_LEAVES.getDefaultState();


    public OrangeSpruceTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn) {
