...
public class GiantBlueSpruceTree extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public GiantBlueSpruceTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn) {
