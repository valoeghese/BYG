...
import sporeaoc.byg.world.worldtypes.islandtype.layers.WarmOceanEdges;
...
public class IslandLayerProvider {
    private static <A extends IArea, R extends IExtendedNoiseRandom<A>> IAreaFactory<A> stackLayers(LongFunction<R> randomProvider) {
        ...
        for (int oceanBiomeSize = 0; oceanBiomeSize <= 3; oceanBiomeSize++) {
        ...
        for (int islandSize = 0; islandSize <= 4; islandSize++) {
