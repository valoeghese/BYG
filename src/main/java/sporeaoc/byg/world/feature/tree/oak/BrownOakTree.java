package sporeaoc.byg.world.feature.tree.oak;
...
public class BrownOakTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public BrownOakTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
