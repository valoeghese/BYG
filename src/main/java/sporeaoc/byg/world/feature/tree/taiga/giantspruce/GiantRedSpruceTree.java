package sporeaoc.byg.world.feature.tree.taiga.giantspruce;
...
public class GiantRedSpruceTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    private static final BlockState LEAVES2 = BYGBlockList.RED_SPRUCE_LEAVES.getDefaultState();
    private static final BlockState BEENEST = Blocks.BEE_NEST.getDefaultState();

    public GiantRedSpruceTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
