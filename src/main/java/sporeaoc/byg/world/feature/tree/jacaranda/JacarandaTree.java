package sporeaoc.byg.world.feature.tree.jacaranda;
...
public class JacarandaTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public JacarandaTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
