package sporeaoc.byg.world.feature.tree.taiga.smallspruce;
...
public class SmallRedSpruceTree extends BYGAbstractTreeFeature<NoFeatureConfig> {
    ...
    public SmallRedSpruceTree(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, int beeHiveChance) {
