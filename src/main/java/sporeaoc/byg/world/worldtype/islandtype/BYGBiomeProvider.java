...
//    private final BYGLayers genBiomes;
//    private final BYGLayers biomeFactoryLayer;
...
//
//    public BYGBiomeProvider(OverworldBiomeProviderSettings settingsProvider) {
...
//        BYGLayers[] alayer = BYGLayerProvider.buildArchipelagoProcedure(worldinfo.getSeed(), worldinfo.getGenerator(), overworldgensettings);
...
//        return this.biomeFactoryLayer.BLSampler(x, y);
//    }
//
//    public Biome func_222366_b(int p_222366_1_, int p_222366_2_) {
//        return this.genBiomes.BLSampler(p_222366_1_, p_222366_2_);
//    }
//
