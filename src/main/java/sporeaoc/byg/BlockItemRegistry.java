...
public class BlockItemRegistry {
    ...
    public static class RegistryEvents {
        ...
        public static void bygRegisterItems(final RegistryEvent.Register<Item> event) {
            event.getRegistry().registerAll();
            LeaveItems.APPLE_SKYRIS_LEAVES = new BlockItem(LeaveBlocks.APPLE_SKYRIS_LEAVES, new Item.Properties().group(ItemGroup.DECORATIONS)).setRegistryName(Objects.requireNonNull(LeaveBlocks.APPLE_SKYRIS_LEAVES.getRegistryName()));
            LeaveItems.BAOBAB_LEAVES = new BlockItem(LeaveBlocks.BAOBAB_LEAVES, new Item.Properties().group(ItemGroup.DECORATIONS)).setRegistryName(Objects.requireNonNull(LeaveBlocks.BAOBAB_LEAVES.getRegistryName()));
        }
