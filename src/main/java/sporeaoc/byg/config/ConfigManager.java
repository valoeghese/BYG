...
public class ConfigManager {
    ...
    public static Config jacarandaforest = new Config("amplifiedbamboojungle", 10);
   ...
   // public static Config prairie = new Config("amplifiedbamboojungle", 3);
    public static Config redoakforest = new Config("amplifiedbamboojungle", 10);
    //public static Config redoakforesthills = new Config("amplifiedbamboojungle", 3);
    public static Config seasonalforest = new Config("amplifiedbamboojungle", 10);
