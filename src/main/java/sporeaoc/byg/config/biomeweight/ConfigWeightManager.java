...
public class ConfigWeightManager {
    ...
    public static ConfigWeight allliumfields = new ConfigWeight("allliumfields", 4);
    public static ConfigWeight alps = new ConfigWeight("alps", 5);
    //public static ConfigWeight ancientForest = new ConfigWeight("ancientForest", 10);
    public static ConfigWeight amaranthfields = new ConfigWeight("amaranthfields", 4);
...
//    public static ConfigWeight bayou = new ConfigWeight("bayou", 10);
    public static ConfigWeight bluetaiga = new ConfigWeight("bluetaiga", 6);
...
//    public static ConfigWeight bog = new ConfigWeight("bog", 10);
    public static ConfigWeight borealforest = new ConfigWeight("borealforest", 6);
...
//    public static ConfigWeight coastalredwoodtropics = new ConfigWeight("coastalredwoodtropics", 10);
    public static ConfigWeight coniferousforest = new ConfigWeight("coniferousforest", 5);
    public static ConfigWeight deciduousforest = new ConfigWeight("deciduousforest", 6);
    public static ConfigWeight dovermountains = new ConfigWeight("dovermountains", 5);
    public static ConfigWeight dunes = new ConfigWeight("dunes", 5);
...
//    public static ConfigWeight enchantedforest = new ConfigWeight("enchantedforest", 10);
    //public static ConfigWeight evergreentaiga = new ConfigWeight("evergreentaiga", 6);
    //    public static ConfigWeight floweringplains = new ConfigWeight("floweringplains", 10);
    public static ConfigWeight giantbluetaiga = new ConfigWeight("bluegianttaiga", 6);
    // public static ConfigWeight glowshroombayou = new ConfigWeight("glowshroombayou", 10);
    public static ConfigWeight grasslandplateau = new ConfigWeight("grasslandplateau", 5);
    //public static ConfigWeight greatlakes = new ConfigWeight("greatlakes", 10);
    public static ConfigWeight guianashield = new ConfigWeight("guianashield", 5);
    public static ConfigWeight jacarandaforest = new ConfigWeight("jacarandaforest", 5);
...
//    public static ConfigWeight pinemountains = new ConfigWeight("pinemountains", 10);
    public static ConfigWeight prairie = new ConfigWeight("prairie", 5);
    //public static ConfigWeight quagmire = new ConfigWeight("quagmire", 10);
    public static ConfigWeight reddesert = new ConfigWeight("reddesert", 6);
    public static ConfigWeight reddesertdunes = new ConfigWeight("reddesertdunes", 5);
    public static ConfigWeight redoakforest = new ConfigWeight("redoakforest", 6);
    //public static ConfigWeight savannacanopy = new ConfigWeight("savannacanopy", 10);
    public static ConfigWeight seasonaldeciduousforest = new ConfigWeight("seasonsaldeciduousforest", 6);
    public static ConfigWeight seasonalforest = new ConfigWeight("seasonalforest", 6);
    public static ConfigWeight seasonalbirchforest = new ConfigWeight("seasonalbirchforest", 6);
    public static ConfigWeight shrublands = new ConfigWeight("shrublands", 6);
    public static ConfigWeight seasonalgianttaiga = new ConfigWeight("seasonalgianttaiga", 6);
    public static ConfigWeight seasonaltaiga = new ConfigWeight("seasonaltaiga", 6);
    //    public static ConfigWeight skyristhighlands = new ConfigWeight("skyrishighlands", 10);
    public static ConfigWeight snowyconiferousforest = new ConfigWeight("snowyconiferousforest", 5);
...
//    public static ConfigWeight snowypinemountains = new ConfigWeight("snowypinemountains", 10);
    public static ConfigWeight snowybluetaiga = new ConfigWeight("snowybluetaiga", 5);
    public static ConfigWeight snowygiantbluetaiga = new ConfigWeight("snowybluegianttaiga", 5);
...
//    public static ConfigWeight stonebrushlands = new ConfigWeight("stonebrushlands", 10);
    public static ConfigWeight tropicalfungalforest = new ConfigWeight("tropicalfungalforest", 5);
    //    public static ConfigWeight tropicalislands = new ConfigWeight("tropicalfungalforest", 10);
    public static ConfigWeight tropicalrainforest = new ConfigWeight("tropicalrainforest", 6);
