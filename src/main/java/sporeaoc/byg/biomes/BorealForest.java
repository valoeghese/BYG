...
public class BorealForest extends Biome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = new ConfiguredSurfaceBuilder<>(BYGSurfaceBuilderCatalog.BOREAL, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG);
