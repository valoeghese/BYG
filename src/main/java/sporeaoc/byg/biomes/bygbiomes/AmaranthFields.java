...
import sporeaoc.byg.world.feature.biomefeatures.BYGOtherFeatures;

public class AmaranthFields extends Biome {
    ...
    public AmaranthFields() {
        ...
        BYGOtherFeatures.addAmaranthFieldFlowers(this);
