...
public class SnowyConiferousForest extends Biome {
    static final ConfiguredSurfaceBuilder SURFACE_BUILDER = new ConfiguredSurfaceBuilder<>(BYGSBList.CONIFEROUS_SB, BYGSBList.PEATGRASS_SB);
    static final RainType PRECIPATATION = RainType.SNOW;
    static final Category CATEGORY = Category.TAIGA;
    static final double DEPTH = 0.85F;
