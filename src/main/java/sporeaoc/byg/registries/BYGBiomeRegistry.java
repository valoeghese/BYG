...
public class BYGBiomeRegistry {
    ...
    public static void registerBiomes(RegistryEvent.Register<Biome> event) {
        ...
        registerBiome(registry, new GrassLandPlateau(), "grasslandplateau", ConfigWeightManager.grasslandplateau.getWeight(), true, BiomeManager.BiomeType.WARM, BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.PLATEAU);
        ...
        registerBiome(registry, new ShrubLands(), "shrublands", ConfigWeightManager.shrublands.getWeight(), true, BiomeManager.BiomeType.DESERT, BiomeDictionary.Type.DRY, BiomeDictionary.Type.SPARSE, BiomeDictionary.Type.PLAINS);
        registerBiome(registry, new SnowyBlueTaiga(), "snowybluetaiga", ConfigWeightManager.snowybluetaiga.getWeight(), true, BiomeManager.BiomeType.ICY, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.CONIFEROUS);
        registerBiome(registry, new SnowyBlueGiantTaiga(), "snowygiantbluetaiga", ConfigWeightManager.snowygiantbluetaiga.getWeight(), true, BiomeManager.BiomeType.ICY, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.SNOWY, BiomeDictionary.Type.CONIFEROUS);
