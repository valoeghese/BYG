    ...
    public static void bygRegisterItems(RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry().registerAll(
               ...
               // ItemCatalogs.AMETRINE_HELMET = new ArmorItem(BYGArmorTiers.AMETRINE, EquipmentSlotType.HEAD, (new Item.Properties()).group(BYG.Init.creativeTab)).setRegistryName("ametrine_helmet"),
                ...
                ItemCatalogs.MAHOGANY_PLANKS = new BlockItem(BlockCatalogs.MAHOGANY_PLANKS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.MAHOGANY_PLANKS.getRegistryName()),
                ...
                ItemCatalogs.MAHOGANY_BOOKSHELF = new BlockItem(BlockCatalogs.MAHOGANY_BOOKSHELF, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.MAHOGANY_BOOKSHELF.getRegistryName()),
                ...
                ItemCatalogs.CYPRESS_SLAB = new BlockItem(BlockCatalogs.CYPRESS_SLAB, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.CYPRESS_SLAB.getRegistryName()),
                ...
                ItemCatalogs.MAHOGANY_SLAB = new BlockItem(BlockCatalogs.MAHOGANY_SLAB, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.MAHOGANY_SLAB.getRegistryName()),
                ...
                //Stairs
                ItemCatalogs.ASPEN_STAIRS = new BlockItem(BlockCatalogs.ASPEN_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.ASPEN_STAIRS.getRegistryName()),
                ItemCatalogs.BAOBAB_STAIRS = new BlockItem(BlockCatalogs.BAOBAB_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.BAOBAB_STAIRS.getRegistryName()),
                ItemCatalogs.BLUE_ENCHANTED_STAIRS = new BlockItem(BlockCatalogs.BLUE_ENCHANTED_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.BLUE_ENCHANTED_STAIRS.getRegistryName()),
                ItemCatalogs.CHERRY_STAIRS = new BlockItem(BlockCatalogs.CHERRY_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.CHERRY_STAIRS.getRegistryName()),
                ItemCatalogs.CIKA_STAIRS = new BlockItem(BlockCatalogs.CIKA_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.CIKA_STAIRS.getRegistryName()),
                ItemCatalogs.CYPRESS_STAIRS = new BlockItem(BlockCatalogs.CYPRESS_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.CYPRESS_STAIRS.getRegistryName()),
                ItemCatalogs.EBONY_STAIRS = new BlockItem(BlockCatalogs.EBONY_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.EBONY_STAIRS.getRegistryName()),
                ItemCatalogs.FIR_STAIRS = new BlockItem(BlockCatalogs.FIR_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.FIR_STAIRS.getRegistryName()),
                ItemCatalogs.GREEN_ENCHANTED_STAIRS = new BlockItem(BlockCatalogs.GREEN_ENCHANTED_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.GREEN_ENCHANTED_STAIRS.getRegistryName()),
                ItemCatalogs.HOLLY_STAIRS = new BlockItem(BlockCatalogs.HOLLY_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.HOLLY_STAIRS.getRegistryName()),
                ItemCatalogs.JACARANDA_STAIRS = new BlockItem(BlockCatalogs.JACARANDA_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.JACARANDA_STAIRS.getRegistryName()),
                ItemCatalogs.MAHOGANY_STAIRS = new BlockItem(BlockCatalogs.MAHOGANY_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.MAHOGANY_STAIRS.getRegistryName()),
                ItemCatalogs.MANGROVE_STAIRS = new BlockItem(BlockCatalogs.MANGROVE_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.MANGROVE_STAIRS.getRegistryName()),
                ItemCatalogs.MAPLE_STAIRS = new BlockItem(BlockCatalogs.MAPLE_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.MAPLE_STAIRS.getRegistryName()),
                ItemCatalogs.PINE_STAIRS = new BlockItem(BlockCatalogs.PINE_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.PINE_STAIRS.getRegistryName()),
                ItemCatalogs.RAINBOW_EUCALYPTUS_STAIRS = new BlockItem(BlockCatalogs.RAINBOW_EUCALYPTUS_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.RAINBOW_EUCALYPTUS_STAIRS.getRegistryName()),
                ItemCatalogs.REDWOOD_STAIRS = new BlockItem(BlockCatalogs.REDWOOD_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.REDWOOD_STAIRS.getRegistryName()),
                ItemCatalogs.SKYRIS_STAIRS = new BlockItem(BlockCatalogs.SKYRIS_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.SKYRIS_STAIRS.getRegistryName()),
                ItemCatalogs.WILLOW_STAIRS = new BlockItem(BlockCatalogs.WILLOW_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.WILLOW_STAIRS.getRegistryName()),
                ItemCatalogs.WITCH_HAZEL_STAIRS = new BlockItem(BlockCatalogs.WITCH_HAZEL_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.WITCH_HAZEL_STAIRS.getRegistryName()),
                ItemCatalogs.ZELKOVA_STAIRS = new BlockItem(BlockCatalogs.ZELKOVA_STAIRS, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.ZELKOVA_STAIRS.getRegistryName()),
...
//
                ...
                ItemCatalogs.MAHOGONY_SAPLING = new BlockItem(BlockCatalogs.MAHOGANY_SAPLING, new Item.Properties().group(BYG.Init.creativeTab)).setRegistryName(BlockCatalogs.MAHOGANY_SAPLING.getRegistryName()),
