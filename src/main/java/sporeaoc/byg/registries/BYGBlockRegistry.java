...
public class BYGBlockRegistry {
    ...
    public static void registerSaplingBlocks(final RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
                BlockCatalogs.ASPEN_LEAVES = new BlockProperties.BlockFlower("aspen_leaves"),
                BlockCatalogs.BAOBAB_LEAVES = new BlockProperties.BlockFlower("baobab_leaves"),
                BlockCatalogs.BLOOMING_WITCH_HAZEL_LEAVES = new BlockProperties.BlockFlower("blooming_witch_hazel_leaves"),
                BlockCatalogs.BLUE_ENCHANTED_LEAVES = new BlockProperties.BlockFlower("blue_enchanted_leaves"),
                BlockCatalogs.BLUE_SPRUCE_LEAVES = new BlockProperties.BlockFlower("blue_spruce_leaves"),
                BlockCatalogs.BROWN_BIRCH_LEAVES = new BlockProperties.BlockFlower("brown_birch_leaves"),
                BlockCatalogs.BROWN_OAK_LEAVES = new BlockProperties.BlockFlower("brown_oak_leaves"),
                BlockCatalogs.CIKA_LEAVES = new BlockProperties.BlockFlower("cika_leaves"),
                BlockCatalogs.CYPRESS_LEAVES = new BlockProperties.BlockFlower("cypress_leaves"),
                BlockCatalogs.EBONY_LEAVES = new BlockProperties.BlockFlower("ebony_leaves"),
                BlockCatalogs.FIR_LEAVES = new BlockProperties.BlockFlower("fir_leaves"),
                BlockCatalogs.FLOWERING_ORCHARD_LEAVES = new BlockProperties.BlockFlower("flowering_orchard_leaves"),
                BlockCatalogs.FLOWERING_PALO_VERDE_LEAVES = new BlockProperties.BlockFlower("flowering_palo_verde_leaves"),
                BlockCatalogs.GREEN_ENCHANTED_LEAVES = new BlockProperties.BlockFlower("green_enchanted_leaves"),
                BlockCatalogs.HOLLY_BERRY_LEAVES = new BlockProperties.BlockFlower("holly_berry_leaves"),
                BlockCatalogs.HOLLY_LEAVES = new BlockProperties.BlockFlower("holly_leaves"),
                BlockCatalogs.JACARANDA_LEAVES = new BlockProperties.BlockFlower("jacaranda_leaves"),
                BlockCatalogs.MAHOGANY_LEAVES = new BlockProperties.BlockFlower("mahogany_leaves"),
                BlockCatalogs.MANGROVE_LEAVES = new BlockProperties.BlockFlower("mangrove_leaves"),
                BlockCatalogs.ORANGE_BIRCH_LEAVES = new BlockProperties.BlockFlower("orange_birch_leaves"),
                BlockCatalogs.ORANGE_OAK_LEAVES = new BlockProperties.BlockFlower("orange_oak_leaves"),
                BlockCatalogs.ORANGE_SPRUCE_LEAVES = new BlockProperties.BlockFlower("orange_spruce_leaves"),
                BlockCatalogs.ORCHARD_LEAVES = new BlockProperties.BlockFlower("orchard_leaves"),
                BlockCatalogs.PALO_VERDE_LEAVES = new BlockProperties.BlockFlower("palo_verde_leaves"),
                BlockCatalogs.PINE_lEAVES = new BlockProperties.BlockFlower("pine_leaves"),
                BlockCatalogs.PINK_CHERRY_LEAVES = new BlockProperties.BlockFlower("pink_cherry_leaves"),
                BlockCatalogs.RAINBOW_EUCALYPTUS_LEAVES = new BlockProperties.BlockFlower("rainbow_eucalyptus_leaves"),
                BlockCatalogs.RED_BIRCH_LEAVES = new BlockProperties.BlockFlower("red_birch_leaves"),
                BlockCatalogs.RED_MAPLE_LEAVES = new BlockProperties.BlockFlower("red_maple_leaves"),
                BlockCatalogs.RED_OAK_LEAVES = new BlockProperties.BlockFlower("red_oak_leaves"),
                BlockCatalogs.RED_SPRUCE_LEAVES = new BlockProperties.BlockFlower("red_spruce_leaves"),
                BlockCatalogs.REDWOOD_LEAVES = new BlockProperties.BlockFlower("redwood_leaves"),
                BlockCatalogs.RIPE_ORCHARD_LEAVES = new BlockProperties.BlockFlower("ripe_orchard_leaves"),
                BlockCatalogs.SILVER_MAPLE_LEAVES = new BlockProperties.BlockFlower("silver_maple_leaves"),
                BlockCatalogs.SKYRIS_LEAVES_GREEN_APPLE = new BlockProperties.BlockFlower("green_apple_skyris_leaves"),
                BlockCatalogs.SKYRIS_LEAVES = new BlockProperties.BlockFlower("skyris_leaves"),
                BlockCatalogs.WHITE_CHERRY_LEAVES = new BlockProperties.BlockFlower("white_cherry_leaves"),
                BlockCatalogs.WILLOW_LEAVES = new BlockProperties.BlockFlower("willow_leaves"),
                BlockCatalogs.WITCH_HAZEL_LEAVES = new BlockProperties.BlockFlower("witch_hazel_leaves"),
                BlockCatalogs.YELLOW_BIRCH_LEAVES = new BlockProperties.BlockFlower("yellow_birch_leaves"),
                BlockCatalogs.YELLOW_SPRUCE_LEAVES = new BlockProperties.BlockFlower("yellow_spruce_leaves")
                /*
