...
public class BYGBlockRegistry {
    ...
    public static void registerLeaveBlocks(final RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
                BYGBlockList.ASPEN_LEAVES = new BYGSnowyLeavesBlock("aspen_leaves"),
                BYGBlockList.BAOBAB_LEAVES = new BYGSnowyLeavesBlock("baobab_leaves"),
                BYGBlockList.BLOOMING_WITCH_HAZEL_LEAVES = new BYGSnowyLeavesBlock("blooming_witch_hazel_leaves"),
                BYGBlockList.BLUE_ENCHANTED_LEAVES = new BYGSnowyLeavesBlock("blue_enchanted_leaves"),
                BYGBlockList.BLUE_SPRUCE_LEAVES = new BYGSnowyLeavesBlock("blue_spruce_leaves"),
                BYGBlockList.BROWN_BIRCH_LEAVES = new BYGSnowyLeavesBlock("brown_birch_leaves"),
                BYGBlockList.BROWN_OAK_LEAVES = new BYGSnowyLeavesBlock("brown_oak_leaves"),
                BYGBlockList.CIKA_LEAVES = new BYGSnowyLeavesBlock("cika_leaves"),
                BYGBlockList.CYPRESS_LEAVES = new BYGSnowyLeavesBlock("cypress_leaves"),
                BYGBlockList.EBONY_LEAVES = new BYGSnowyLeavesBlock("ebony_leaves"),
                BYGBlockList.FIR_LEAVES = new BYGSnowyLeavesBlock("fir_leaves"),
                BYGBlockList.FLOWERING_ORCHARD_LEAVES = new BYGSnowyLeavesBlock("flowering_orchard_leaves"),
                BYGBlockList.FLOWERING_PALO_VERDE_LEAVES = new BYGSnowyLeavesBlock("flowering_palo_verde_leaves"),
                BYGBlockList.GREEN_ENCHANTED_LEAVES = new BYGSnowyLeavesBlock("green_enchanted_leaves"),
                BYGBlockList.HOLLY_BERRY_LEAVES = new BYGSnowyLeavesBlock("holly_berry_leaves"),
                BYGBlockList.HOLLY_LEAVES = new BYGSnowyLeavesBlock("holly_leaves"),
                BYGBlockList.JACARANDA_LEAVES = new BYGSnowyLeavesBlock("jacaranda_leaves"),
                BYGBlockList.MAHOGANY_LEAVES = new BYGSnowyLeavesBlock("mahogany_leaves"),
                BYGBlockList.MANGROVE_LEAVES = new BYGSnowyLeavesBlock("mangrove_leaves"),
                BYGBlockList.ORANGE_BIRCH_LEAVES = new BYGSnowyLeavesBlock("orange_birch_leaves"),
                BYGBlockList.ORANGE_OAK_LEAVES = new BYGSnowyLeavesBlock("orange_oak_leaves"),
                BYGBlockList.ORANGE_SPRUCE_LEAVES = new BYGSnowyLeavesBlock("orange_spruce_leaves"),
                BYGBlockList.ORCHARD_LEAVES = new BYGSnowyLeavesBlock("orchard_leaves"),
                BYGBlockList.PALO_VERDE_LEAVES = new BYGSnowyLeavesBlock("palo_verde_leaves"),
                BYGBlockList.PINE_LEAVES = new BYGSnowyLeavesBlock("pine_leaves"),
                BYGBlockList.PINK_CHERRY_LEAVES = new BYGSnowyLeavesBlock("pink_cherry_leaves"),
                BYGBlockList.RAINBOW_EUCALYPTUS_LEAVES = new BYGSnowyLeavesBlock("rainbow_eucalyptus_leaves"),
                BYGBlockList.RED_BIRCH_LEAVES = new BYGSnowyLeavesBlock("red_birch_leaves"),
                BYGBlockList.RED_MAPLE_LEAVES = new BYGSnowyLeavesBlock("red_maple_leaves"),
                BYGBlockList.RED_OAK_LEAVES = new BYGSnowyLeavesBlock("red_oak_leaves"),
                BYGBlockList.RED_SPRUCE_LEAVES = new BYGSnowyLeavesBlock("red_spruce_leaves"),
                BYGBlockList.REDWOOD_LEAVES = new BYGSnowyLeavesBlock("redwood_leaves"),
                BYGBlockList.RIPE_ORCHARD_LEAVES = new BYGSnowyLeavesBlock("ripe_orchard_leaves"),
                BYGBlockList.SILVER_MAPLE_LEAVES = new BYGSnowyLeavesBlock("silver_maple_leaves"),
                BYGBlockList.SKYRIS_LEAVES_GREEN_APPLE = new BYGSnowyLeavesBlock("green_apple_skyris_leaves"),
                BYGBlockList.SKYRIS_LEAVES = new BYGSnowyLeavesBlock("skyris_leaves"),
                BYGBlockList.WHITE_CHERRY_LEAVES = new BYGSnowyLeavesBlock("white_cherry_leaves"),
                BYGBlockList.WILLOW_LEAVES = new BYGSnowyLeavesBlock("willow_leaves"),
                BYGBlockList.WITCH_HAZEL_LEAVES = new BYGSnowyLeavesBlock("witch_hazel_leaves"),
                BYGBlockList.YELLOW_BIRCH_LEAVES = new BYGSnowyLeavesBlock("yellow_birch_leaves"),
                BYGBlockList.YELLOW_SPRUCE_LEAVES = new BYGSnowyLeavesBlock("yellow_spruce_leaves")
