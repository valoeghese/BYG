...
public class BYGBlockRegistry {
    ...
    public static void bygRegisterBlocks(final RegistryEvent.Register<Block> event) {
        ...
        event.getRegistry().registerAll
                ...
                BlockCatalogs.HOLLY_BETTER_LEAVES = new LeavesBlock(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT)).setRegistryName(location("holly_berry_leaves")),
                ...
                //MushroomBlocks
                BlockCatalogs.BLACK_PUFF = new MushroomBlock(Block.Properties.create(Material.WOOD, MaterialColor.DIRT).hardnessAndResistance(0.2F).sound(SoundType.WOOD)).setRegistryName("black_puff"),
                BlockCatalogs.WEEPING_MILKCAP = new MushroomBlock(Block.Properties.create(Material.WOOD, MaterialColor.DIRT).hardnessAndResistance(0.2F).sound(SoundType.WOOD)).setRegistryName("weeping_milkcap"),
                BlockCatalogs.WOOD_BLEWIT = new MushroomBlock(Block.Properties.create(Material.WOOD, MaterialColor.DIRT).hardnessAndResistance(0.2F).sound(SoundType.WOOD)).setRegistryName("wood_blewit"),
                ...
                BlockCatalogs.STRIPPED_MAHOGONY_LOG = new LogBlock(MaterialColor.OBSIDIAN, Block.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName("stripped_mahogony_log"),
                ...
                BlockCatalogs.STRIPPED_RAINBOW_LOG = new LogBlock(MaterialColor.OBSIDIAN, Block.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(2.0F).sound(SoundType.WOOD)).setRegistryName("stripped_rainbow_log"),
