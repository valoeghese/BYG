...
public class BYGBlockRegistry {
    ...
    public static void registerPlankBlocks(final RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
            ...
            //Slabs
                BYGBlockList.ASPEN_SLAB = new BYGBlockProperties.BYGSlab("aspen_slab"),
                BYGBlockList.BAOBAB_SLAB = new BYGBlockProperties.BYGSlab("baobab_slab"),
                BYGBlockList.BLUE_ENCHANTED_SLAB = new BYGBlockProperties.BYGSlab("blue_enchanted_slab"),
                BYGBlockList.CHERRY_SLAB = new BYGBlockProperties.BYGSlab("cherry_slab"),
                BYGBlockList.CIKA_SLAB = new BYGBlockProperties.BYGSlab("cika_slab"),
                BYGBlockList.CYPRESS_SLAB = new BYGBlockProperties.BYGSlab("cypress_slab"),
                BYGBlockList.EBONY_SLAB = new BYGBlockProperties.BYGSlab("ebony_slab"),
                BYGBlockList.FIR_SLAB = new BYGBlockProperties.BYGSlab("fir_slab"),
                BYGBlockList.GREEN_ENCHANTED_SLAB = new BYGBlockProperties.BYGSlab("green_enchanted_slab"),
                BYGBlockList.HOLLY_SLAB = new BYGBlockProperties.BYGSlab("holly_slab"),
                BYGBlockList.JACARANDA_SLAB = new BYGBlockProperties.BYGSlab("jacaranda_slab"),
                BYGBlockList.MAHOGANY_SLAB = new BYGBlockProperties.BYGSlab("mahogany_slab"),
                BYGBlockList.MANGROVE_SLAB = new BYGBlockProperties.BYGSlab("mangrove_slab"),
                BYGBlockList.MAPLE_SLAB = new BYGBlockProperties.BYGSlab("maple_slab"),
                BYGBlockList.PINE_SLAB = new BYGBlockProperties.BYGSlab("pine_slab"),
                BYGBlockList.RAINBOW_EUCALYPTUS_SLAB = new BYGBlockProperties.BYGSlab("rainbow_eucalyptus_slab"),
                BYGBlockList.REDWOOD_SLAB = new BYGBlockProperties.BYGSlab("redwood_slab"),
                BYGBlockList.SKYRIS_SLAB = new BYGBlockProperties.BYGSlab("skyris_slab"),
                BYGBlockList.WILLOW_SLAB = new BYGBlockProperties.BYGSlab("willow_slab"),
                BYGBlockList.WITCH_HAZEL_SLAB = new BYGBlockProperties.BYGSlab("witch_hazel_slab"),
                BYGBlockList.ZELKOVA_SLAB = new BYGBlockProperties.BYGSlab("zelkova_slab"),

            //Stairs
                BYGBlockList.ASPEN_STAIRS = new BYGBlockProperties.BYGPlanks("aspen_stairs"),
                BYGBlockList.BAOBAB_STAIRS = new BYGBlockProperties.BYGPlanks("baobab_stairs"),
                BYGBlockList.BLUE_ENCHANTED_STAIRS = new BYGBlockProperties.BYGPlanks("blue_enchanted_stairs"),
                BYGBlockList.CHERRY_STAIRS = new BYGBlockProperties.BYGPlanks("cherry_stairs"),
                BYGBlockList.CIKA_STAIRS = new BYGBlockProperties.BYGPlanks("cika_stairs"),
                BYGBlockList.CYPRESS_STAIRS = new BYGBlockProperties.BYGPlanks("cypress_stairs"),
                BYGBlockList.EBONY_STAIRS = new BYGBlockProperties.BYGPlanks("ebony_stairs"),
                BYGBlockList.FIR_STAIRS = new BYGBlockProperties.BYGPlanks("fir_stairs"),
                BYGBlockList.GREEN_ENCHANTED_STAIRS = new BYGBlockProperties.BYGPlanks("green_enchanted_stairs"),
                BYGBlockList.HOLLY_STAIRS = new BYGBlockProperties.BYGPlanks("holly_stairs"),
                BYGBlockList.JACARANDA_STAIRS = new BYGBlockProperties.BYGPlanks("jacaranda_stairs"),
                BYGBlockList.MAHOGANY_STAIRS = new BYGBlockProperties.BYGPlanks("mahogany_stairs"),
                BYGBlockList.MANGROVE_STAIRS = new BYGBlockProperties.BYGPlanks("mangrove_stairs"),
                BYGBlockList.MAPLE_STAIRS = new BYGBlockProperties.BYGPlanks("maple_stairs"),
                BYGBlockList.PINE_STAIRS = new BYGBlockProperties.BYGPlanks("pine_stairs"),
                BYGBlockList.RAINBOW_EUCALYPTUS_STAIRS = new BYGBlockProperties.BYGPlanks("rainbow_eucalyptus_stairs"),
                BYGBlockList.REDWOOD_STAIRS = new BYGBlockProperties.BYGPlanks("redwood_stairs"),
                BYGBlockList.SKYRIS_STAIRS = new BYGBlockProperties.BYGPlanks("skyris_stairs"),
                BYGBlockList.WILLOW_STAIRS = new BYGBlockProperties.BYGPlanks("willow_stairs"),
                BYGBlockList.WITCH_HAZEL_STAIRS = new BYGBlockProperties.BYGPlanks("witch_hazel_stairs"),
                BYGBlockList.ZELKOVA_STAIRS = new BYGBlockProperties.BYGPlanks("zelkova_stairs")
    ...
    public static void registerFenceBlocks(final RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
                ...
                BYGBlockList.MAHOGONY_FENCE = new BYGBlockProperties.BYGFence("mahogany_fence"),
    ...
    public static void registerSaplingBlocks(final RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
                ...
                BYGBlockList.MAHOGANY_SAPLING = new BYGBlockProperties.BYGFlower("mahogany_sapling"),
                ...
                BYGBlockList.SILVER_MAPLE_SAPLINGS = new BYGBlockProperties.BYGFlower("silver_maple_sapling"),
    ...
    public static void registerPlantBlocks(final RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
                ...
                BYGBlockList.BLUE_GLOWCANE_BLOCK = new BYGBlockProperties.BYGGlow("blue_glowcane_block"),
                BYGBlockList.RED_GLOWCANE_BLOCK = new BYGBlockProperties.BYGGlow("red_glowcane_block"),
                BYGBlockList.PINK_GLOWCANE_BLOCK = new BYGBlockProperties.BYGGlow("pink_glowcane_block"),
                BYGBlockList.PURPLE_GLOWCANE_BLOCK = new BYGBlockProperties.BYGGlow("purple_glowcane_block"),
...
//EEEE
    ...
    public static void registerFlowerBlocks(final RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
                ...
                BYGBlockList.AZALEA = new BYGBlockProperties.BYGFlower("azalea"),
