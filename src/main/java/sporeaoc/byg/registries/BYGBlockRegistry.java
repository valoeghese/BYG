...
public class BYGBlockRegistry {
    ...
    public static void registerPlankBlocks(final RegistryEvent.Register<Block> event) {
        event.getRegistry().registerAll(
                ...
                BlockCatalogs.BAOBAB_BOOKSHELF = new BlockProperties.BlockBookshelf("baobab_bookshelf"),
                BlockCatalogs.BLUE_ENCHANTED_BOOKSHELF = new BlockProperties.BlockBookshelf("blue_enchanted_bookshelf"),
                BlockCatalogs.CHERRY_BOOKSHELF = new BlockProperties.BlockBookshelf("cherry_bookshelf"),
                BlockCatalogs.CIKA_BOOKSHELF = new BlockProperties.BlockBookshelf("cika_bookshelf"),
                BlockCatalogs.CYPRESS_BOOKSHELF = new BlockProperties.BlockBookshelf("cypress_bookshelf"),
                BlockCatalogs.EBONY_BOOKSHELF = new BlockProperties.BlockBookshelf("ebony_bookshelf"),
                BlockCatalogs.FIR_BOOKSHELF = new BlockProperties.BlockBookshelf("fir_bookshelf"),
                BlockCatalogs.GREEN_ENCHANTED_BOOKSHELF = new BlockProperties.BlockBookshelf("green_enchanted_bookshelf"),
                BlockCatalogs.HOLLY_BOOKSHELF = new BlockProperties.BlockBookshelf("holly_bookshelf"),
                BlockCatalogs.JACARANDA_BOOKSHELF = new BlockProperties.BlockBookshelf("jacaranda_bookshelf"),
                BlockCatalogs.MAHOGANY_BOOKSHELF = new BlockProperties.BlockBookshelf("mahogany_bookshelf"),
                BlockCatalogs.MANGROVE_BOOKSHELF = new BlockProperties.BlockBookshelf("mangrove_bookshelf"),
                BlockCatalogs.MAPLE_BOOKSHELF = new BlockProperties.BlockBookshelf("maple_bookshelf"),
                BlockCatalogs.PINE_BOOKSHELF = new BlockProperties.BlockBookshelf("pine_bookshelf"),
                BlockCatalogs.RAINBOW_EUCALYPTUS_BOOKSHELF = new BlockProperties.BlockBookshelf("rainbow_eucalyptus_bookshelf"),
                BlockCatalogs.REDWOOD_BOOKSHELF = new BlockProperties.BlockBookshelf("redwood_bookshelf"),
                BlockCatalogs.SKYRIS_BOOKSHELF = new BlockProperties.BlockBookshelf("skyris_bookshelf"),
                BlockCatalogs.WILLOW_BOOKSHELF = new BlockProperties.BlockBookshelf("willow_bookshelf"),
                BlockCatalogs.WITCH_HAZEL_BOOKSHELF = new BlockProperties.BlockBookshelf("witch_hazel_bookshelf"),
                BlockCatalogs.ZELKOVA_BOOKSHELF = new BlockProperties.BlockBookshelf("zelkova_bookshelf"),

            //Slabs
                BlockCatalogs.ASPEN_SLAB = new BlockProperties.BlockSlab("aspen_slab"),
                BlockCatalogs.BAOBAB_SLAB = new BlockProperties.BlockSlab("baobab_slab"),
                BlockCatalogs.BLUE_ENCHANTED_SLAB = new BlockProperties.BlockSlab("blue_enchanted_slab"),
                BlockCatalogs.CHERRY_SLAB = new BlockProperties.BlockSlab("cherry_slab"),
                BlockCatalogs.CIKA_SLAB = new BlockProperties.BlockSlab("cika_slab"),
                BlockCatalogs.CYPRESS_SLAB = new BlockProperties.BlockSlab("cypress_slab"),
                BlockCatalogs.EBONY_SLAB = new BlockProperties.BlockSlab("ebony_slab"),
                BlockCatalogs.FIR_SLAB = new BlockProperties.BlockSlab("fir_slab"),
                BlockCatalogs.GREEN_ENCHANTED_SLAB = new BlockProperties.BlockSlab("green_enchanted_slab"),
                BlockCatalogs.HOLLY_SLAB = new BlockProperties.BlockSlab("holly_slab"),
                BlockCatalogs.JACARANDA_SLAB = new BlockProperties.BlockSlab("jacaranda_slab"),
                BlockCatalogs.MAHOGANY_SLAB = new BlockProperties.BlockSlab("mahogany_slab"),
                BlockCatalogs.MANGROVE_SLAB = new BlockProperties.BlockSlab("mangrove_slab"),
                BlockCatalogs.MAPLE_SLAB = new BlockProperties.BlockSlab("maple_slab"),
                BlockCatalogs.PINE_SLAB = new BlockProperties.BlockSlab("pine_slab"),
                BlockCatalogs.RAINBOW_EUCALYPTUS_SLAB = new BlockProperties.BlockSlab("rainbow_eucalyptus_slab"),
                BlockCatalogs.REDWOOD_SLAB = new BlockProperties.BlockSlab("redwood_slab"),
                BlockCatalogs.SKYRIS_SLAB = new BlockProperties.BlockSlab("skyris_slab"),
                BlockCatalogs.WILLOW_SLAB = new BlockProperties.BlockSlab("willow_slab"),
                BlockCatalogs.WITCH_HAZEL_SLAB = new BlockProperties.BlockSlab("witch_hazel_slab"),
                BlockCatalogs.ZELKOVA_SLAB = new BlockProperties.BlockSlab("zelkova_slab"),
