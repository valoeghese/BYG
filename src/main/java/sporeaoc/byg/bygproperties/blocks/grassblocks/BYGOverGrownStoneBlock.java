...
public class BYGOverGrownStoneBlock extends SpreadableSnowyOvergrownStoneBlock implements IGrowable {
    public BYGOverGrownStoneBlock(Block.Properties properties) {
        super(properties);
    }
