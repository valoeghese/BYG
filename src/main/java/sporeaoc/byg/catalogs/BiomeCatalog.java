...
public class BiomeCatalog {
    ...
    public static Biome EVERGREENTAIGA = new AlliumFields();
    public static Biome FLOWERINGPLAINS = new AlliumFields();
    public static Biome GLOWSHROOMBAYOU = new AlliumFields();
    public static Biome GREATLAKES = new AlliumFields();
    public static Biome GUIANASHIELD = new AlliumFields();
    public static Biome MANGROVEMARSHES = new AlliumFields();
    public static Biome MAPLETAIGA = new AlliumFields();
    public static Biome MARSHLANDS = new AlliumFields();
    public static Biome MEADOW = new AlliumFields();
    public static Biome ORCHARD = new AlliumFields();
    public static Biome PINELOWANDS = new AlliumFields();
    public static Biome PINEMOUNTAINS = new AlliumFields();
    public static Biome SAVANNACANOPY = new AlliumFields();
    public static Biome SKYRISHIGHLANDS = new AlliumFields();
    public static Biome SNOWYCONIFEROUSFOREST = new AlliumFields();
    public static Biome SNOWYDECIDUOUSFOREST = new AlliumFields();
    public static Biome SNOWYEVERGREENTAIGA = new AlliumFields();
    public static Biome SNOWYPINEMOUNTAINS = new AlliumFields();
    public static Biome SONORANDESERT = new AlliumFields();
    public static Biome STONEBRUSHLANDS = new AlliumFields();
    public static Biome TROPICALFUNGALRAINFOREST = new AlliumFields();
    public static Biome TROPICALISLANDS = new AlliumFields();
    public static Biome TROPICALRAINFOREST = new AlliumFields();
    public static Biome WEEPINGWITCHFOREST = new AlliumFields();
    public static Biome WOODLANDS = new AlliumFields();
    public static Biome ZELKOVAFOREST = new AlliumFields();
